...
class MainTrendCatResultVC: UIViewController, NVActivityIndicatorViewable, UITextFieldDelegate {
    ...
    func init_UI()
    {
        ...
        category_title.text = ShareData.trend_selected_category.name!
...
extension MainTrendCatResultVC: UITableViewDelegate, UITableViewDataSource
{
