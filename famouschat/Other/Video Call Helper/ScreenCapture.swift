...
class ScreenCapture: QBRTCVideoCapture {
    ...
    static let sharedGPUContextSharedContext: CIContext = {
        let options = [CIContextOption.init(string:kCIContextWorkingColorSpace): true]
        let sharedContext = CIContext(options: options as [String : Any])
...
//                                                  name: UIApplication.NSNotification.Name.UIApplicationWillEnterForeground,
//                                                  object: nil)
//
//        NotificationCenter.default.removeObserver(self,
//                                                  name: UIApplication.didEnterBackgroundNotification,
